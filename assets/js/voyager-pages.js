(function () {
    ...
    const PAGE_DATA = {
        voyager1: {
            ...
            quiz: [
                { q: 'Why did Voyager 1 not continue on to Uranus and Neptune?', choices: ['Its cameras failed at Saturn', 'Its Titan flyby bent it out of the planetary plane', 'NASA canceled all outer-planet targets in 1979', 'Jupiter gravity pushed it back inward'], correct: 1, exp: 'Voyager 1’s close Titan encounter changed its path, sending it north out of the ecliptic instead of toward Uranus and Neptune.' },
                { q: 'Which milestone makes Voyager 1 unique among all spacecraft?', choices: ['First spacecraft to Jupiter', 'First probe to visit Uranus', 'First human-made object to enter interstellar space', 'First mission to carry plutonium power'], correct: 2, exp: 'Voyager 1 became the first human-made object to enter interstellar space in August 2012.' },
                { q: 'Which pair of giant planets did Voyager 1 fly past up close?', choices: ['Jupiter and Saturn', 'Saturn and Uranus', 'Uranus and Neptune', 'Jupiter and Neptune'], correct: 0, exp: 'Voyager 1’s prime planetary tour covered Jupiter and Saturn.' },
                { q: 'What famous moon strongly shaped Voyager 1’s trajectory after Saturn?', choices: ['Europa', 'Triton', 'Titan', 'Enceladus'], correct: 2, exp: 'Titan was such a high-priority target that the flyby geometry set Voyager 1 on its interstellar path.' },
                { q: 'What is the Golden Record?', choices: ['A backup computer memory system', 'A gold-plated information disc intended as an Earth time capsule', 'A sun sensor for navigation', 'A propulsion experiment'], correct: 1, exp: 'The Golden Record is a curated message from Earth mounted on the spacecraft.' },
                { q: 'What kind of science does Voyager 1 still do best today?', choices: ['Surface geology', 'Fields-and-particles measurements in deep space', 'Weather imaging at Saturn', 'Radar mapping'], correct: 1, exp: 'With cameras long off, Voyager 1’s most valuable modern science comes from fields-and-particles instruments.' }
            ],
            sources: [
        ...
        voyager2: {
            ...
            quiz: [
                { q: 'What makes Voyager 2 unique in planetary exploration history?', choices: ['It was the first spacecraft to leave Earth orbit', 'It is the only spacecraft to visit Uranus and Neptune', 'It returned samples from Jupiter', 'It orbited all four giant planets'], correct: 1, exp: 'Voyager 2 remains the only spacecraft to have visited Uranus and Neptune.' },
                { q: 'Which sequence correctly lists Voyager 2’s giant-planet flybys?', choices: ['Saturn, Jupiter, Uranus, Neptune', 'Jupiter, Saturn, Uranus, Neptune', 'Jupiter, Uranus, Saturn, Neptune', 'Saturn, Uranus, Neptune, Jupiter'], correct: 1, exp: 'Voyager 2 flew by Jupiter, then Saturn, then Uranus, then Neptune.' },
                { q: 'Why was Voyager 2 able to continue on to Uranus and Neptune after Saturn?', choices: ['It had onboard nuclear engines', 'Its Saturn geometry preserved a path deeper into the outer solar system', 'It used a lunar gravity assist', 'NASA relaunched it from Jupiter'], correct: 1, exp: 'Voyager 2’s path after Saturn was designed to keep the Grand Tour going toward Uranus and Neptune.' },
                { q: 'Which planet did Voyager 2 reveal to have a surprisingly dynamic atmosphere with strong winds and a Great Dark Spot?', choices: ['Jupiter', 'Saturn', 'Uranus', 'Neptune'], correct: 3, exp: 'Voyager 2 showed Neptune to be far more meteorologically active than many scientists expected.' },
                { q: 'What happened to Voyager 2 in 2018?', choices: ['It reached the asteroid belt', 'It entered interstellar space', 'It orbited Neptune again', 'It stopped transmitting permanently'], correct: 1, exp: 'Voyager 2 crossed the heliopause and entered interstellar space in 2018.' },
                { q: 'Why is Voyager 2 still scientifically valuable today?', choices: ['It can still land on moons', 'It provides direct measurements at the edge of and beyond the heliosphere', 'It still takes high-resolution color images', 'It refuels using solar panels'], correct: 1, exp: 'Voyager 2 gives scientists in-situ measurements of regions no other active spacecraft is traversing.' }
            ],
            sources: [
    ...
    function updateAssemblyStatus(message) {
        ...
        if (hint) {
            if (message) {
                ...
                hint.textContent = item ? item.summary : 'Select a spacecraft part or instrument.';
            } else {
